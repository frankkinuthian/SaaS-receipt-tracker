    ...
    async (files: FileList | File[]) => {
      ...
      try {
        ...
        for (const file of pdfFiles) {
          // Create a formData object for use with server action
          const formData = new FormData();
          formData.append("file", file);

          // Make server request to upload file
        ...
        >
          {isUploading ? (
            ...
            <>
              ...
              />
              <Button
                className="mt-4 px-4 py-2 bg-blue-50 text-white rounded hover:bg-blue-600 disabled:opacity-50 disabled:cursor-not-allowed"
